...
(function (factory) {
  ...
  var uploadFileCampus = function(files,cb){
    ...
    xhr.open('post', 'http://120.25.68.86:21310/v1/common/upload'); // url 为提交的后台地址
    xhr.send(formData);
    ...
    xhr.onreadystatechange = function() {
      ...
      if (xhr.readyState == 4) {
        ...
        if (xhr.status === 200) {
          ...
          cb(JSON.parse(message).resultData[0].image);
  ...
  var async = (function () {
    ...
    var readFileAsHttpURL = function (file) {
    ...
    this.insertImages = function (files) {
      $.each(files, function (idx, file) {
        ...
        if (options.maximumImageFileSize && options.maximumImageFileSize < file.size) {
          ...
          //  var result = self.insertImage(dataURL, filename);
          //
          //  return result;
          //}).
          //fail(function () {
          ...
          uploadFileCampus(file,function(dataURL){
